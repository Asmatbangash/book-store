...
function Navbar() {
  ...
  return (
    <div
      className={`w-screen-full space-x-7 md:space-x-0 mx-auto max-sm:px-0  px-6  navbar bg-base-100 shadow-sm fixed top-0 left-0 right-0 z-1 dark:bg-slate-900 dark:text-white dark:border-b-1  ${
        sticky
          ? "sticky-navbar top-0 bg-base-300 duration-300 transition-all ease-in-out shadow-md z-50 dark:bg-base-200"
          : ""
      }`}
    >
