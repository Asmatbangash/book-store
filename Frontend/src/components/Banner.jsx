...
function Banner() {
  ...
  <div className="hero-content w-1/1 flex-col lg:flex-row-reverse">
    ...
    <div className='w-screen-full'>
      ...
      <InputBox type='email' placeholder='@email.com' className='input w-full rounded-full px-8 py-3 focus:outline-none focus:border-blue-500 placeholder-gray-400 transition-all duration-300 dark:bg-gray-400 dark:placeholder-gray-100 dark:text-gray-100'/>
     </label>
</form>
      </div>
